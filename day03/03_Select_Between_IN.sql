/*
  ...
  Between belirttigimiz 2 veri arasidaki bilgileri listeler. Between de belirttigimiz degerlerde listelemeye dahildir.
*/
...
/*
 ...
 IN : Birden fazla mantiksal ifade ile tanimlayabilecegimiz durumlari tek komutta yazabilme imkani verir. Farkli sutunlar icin IN KULLANILAMAZ
*/
...
--TASK-2 : Derya Soylu ile Yavuz Bal arasindaki personel bilgisini listeleyiniz.

Select * From personel Where isim Between 'Derya Soylu' And 'Yavuz Bal';



--TASK-3 : Maasi 70000 ve ismi Sena olan personeli listele

Select * From personel Where maas = 70000 OR isim = 'Sena Beyaz'; -- iki sarti birden saglayan veri olmadigi icin And'de bos gelir



--TASK-4 : id'si 1001, 1002 ve 1004 olan personelin bilgilerini listele
...
--TASK-5 : maasi sadece 70000, 100000 olan personeli listele
